/**
 * Module 3 Test Runner
 * 
 * Demonstrates the complete flow:
 * 1. Load metrics from Module 1 (JSON)
 * 2. Run Module 2 reasoning engine
 * 3. Feed decisions to Module 3 executor
 * 4. Show outcomes + learning memory
 * 
 * Run with: npx tsx src/executor/testModule3Runner.ts
 */
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════════╗');
  console.log('║  Module 3: Action Executor Test Runner                        ║');
  ...
  try {
    ...
    // Step 4: Execute decision via Module 3
    console.log('[TEST] Feeding decision to Module 3 executor...');
    ...
    displayLearningMemory();

    // Step 8: Run another cycle to show memory accumulation
    console.log('\n[TEST] Simulating second cycle (to demonstrate memory accumulation)...');
    const secondResult = await executeDecision(executorInput);
    console.log();
